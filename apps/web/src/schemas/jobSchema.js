...
export const jobSchema = z.object({
  ...
  start_date: z.string().optional().or(z.literal('')).nullable().transform(val => val || null),
  end_date: z.string().optional().or(z.literal('')).nullable().transform(val => val || null),
  notes: z.string().optional().or(z.literal('')).nullable().transform(val => val || null)
}).refine((data) => {
