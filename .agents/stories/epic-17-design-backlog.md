...
- [ ] **Task 17.18: "Log Payment" Modal**
  - **Description:** A modal triggered from the Invoice Details screen.
  - **Content:** Inputs: Payment Amount (defaults to remaining balance), Payment Date, Payment Method (dropdown: Cash, Check, Credit Card, Zelle, Bank Transfer), and optional Notes.
